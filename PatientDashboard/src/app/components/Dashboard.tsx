          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="mt-1" style={{ fontWeight: 500 }}>47 years</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mt-1" style={{ fontWeight: 500 }}>White</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mt-1" style={{ fontWeight: 500 }}>English, Russian</p>
              </div>
              <div>
          ...
          <div className="border-t border-border pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="mt-1" style={{ fontWeight: 500 }}>Space Motion Sickness, Spinal Elongation</p>
              </div>
              <div>
                <p className="text-muted-foreground" style={{ fontSize: '14px' }}>Current Medications</p>
                <p className="mt-1" style={{ fontWeight: 500 }}>Dramamine 50 mg</p>
              </div>
            </div>
          </div>
