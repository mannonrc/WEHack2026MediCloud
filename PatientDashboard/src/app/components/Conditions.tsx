  ...
  const conditions = [
    {
      ...
      severity: 'Moderate',
      treatment: 'Dramamine 50 mg as needed, lifestyle modifications',
      notes: 'Patient responds well to medication. Monitored regularly.',
      lastReviewed: '2026-04-01',
    },
    {
      name: 'Spinal Elongation',
      status: 'Active',
      diagnosedDate: '2026-04-10',
      diagnosedBy: 'Dr. Michael Chen',
      severity: 'Mild',
      treatment: 'Normal gravity and yoga.',
      notes: 'Patient follows recommended exercise plan and has not yet returned to microgravity. No guarantees.',
