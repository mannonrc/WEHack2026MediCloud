    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Track your known allergies and reactions
          </p>
        </div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <div className="flex gap-3">
          ...
          <div>
            <p style={{ fontWeight: 500 }} className="text-yellow-900 mb-1">
              Critical Alert
            </p>
            <p style={{ fontSize: '14px' }} className="text-yellow-800">
              Always inform healthcare providers about these allergies before receiving any medications or treatments. Consider wearing a medical alert bracelet for severe allergies.
            </p>
          </div>
        </div>
      </div>
