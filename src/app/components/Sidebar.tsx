import { Home, FileText, Pill, Stethoscope, AlertTriangle, AlertCircle, Calendar, FolderOpen, User, Share2 } from 'lucide-react';
...
export function Sidebar({ activeSection, onSectionChange }: SidebarProps) {
  const menuItems = [
    ...
    { id: 'shared', label: 'Shared Access', icon: Share2 },
